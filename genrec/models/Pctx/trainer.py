...
class PctxTrainer:
    ...
    def __init__(self, config: dict, model: AbstractModel, tokenizer: AbstractTokenizer,Round):
    ...
    def fit(self, train_dataloader, val_dataloader):
        ...
        for epoch in range(n_epochs):
            ...
            if (epoch + 1) % self.config['eval_interval'] == 0:
                ...
                all_results = self.evaluate(val_dataloader, split='val',epoch=epoch+1)
                ...
                if val_score > best_val_score:
                    ...
                    best_epoch = epoch + 1
                    #new below, without this line of code, run_hyper.py 's log no best_valid results
                    #totally 3 or 4 changes, one in run_hyper, one is here, one in pipeline.py
    ...
    def evaluate(self, dataloader, split='test',epoch=-666):
